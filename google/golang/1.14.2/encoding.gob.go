...
/* Basic: This example shows the basic usage of the package: Create an encoder, transmit some values, receive them with a decoder.
package main
...
*/
/* EncodeDecode: This example transmits a value that implements the custom encoding and decoding methods.
package main
...
*/
/* Interface: This example shows how to encode an interface value.
