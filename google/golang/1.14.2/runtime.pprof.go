...
func NewProfile(name string) *Profile {
	// possible: panic("pprof: NewProfile with empty name")
	// possible: panic("pprof: NewProfile name already in use: " + name)
}
...
func (p *Profile) Add(value interface{}, skip int) {
	// possible: panic("pprof: use of uninitialized Profile")
	// possible: panic("pprof: Add called on built-in Profile " + p.name)
	// possible: panic("pprof: Profile.Add of duplicate value")
}
...
func (p *Profile) WriteTo(w io.Writer, debug int) error {
	// possible: panic("pprof: use of zero Profile")
}
...
func Labels(args ...string) LabelSet {
	// possible: panic("uneven number of arguments to pprof.Labels")
}
